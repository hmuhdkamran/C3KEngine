...
impl LoanApplications {
    ...
    pub const PK: &'static str = r#"LoanApplicationId::TEXT=$1"#;
    pub const COLUMNS: &'static str = r#""LoanApplicationId","ApplicationDate","EmployeeId","LoanTypeId","LoanAmount","ApplicationStatusId","Remarks","StatusId","NumberOfInstallment""#;
    pub const COLUMNS_UPDATE: &'static str = r#""LoanApplicationId"=$1,"ApplicationDate"=$2,"EmployeeId"=$3,"LoanTypeId"=$4,"LoanAmount"=$5,"ApplicationStatusId"=$6,"Remarks"=$7,"StatusId"=$8,"NumberOfInstallment"=$9 WHERE "LoanApplicationId"=$1"#;

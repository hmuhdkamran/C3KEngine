...
impl Attributes {
    ...
    pub const COLUMNS: &'static str = r#""AttributeId","Abbreviation","FullName","StatusId""#;
    pub const COLUMNS_UPDATE: &'static str = r#""AttributeId"=$1,"Abbreviation"=$2,"FullName"=$3,"StatusId"=$4 WHERE "AttributeId"=$1"#;

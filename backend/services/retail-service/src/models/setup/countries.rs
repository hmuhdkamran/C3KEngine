...
impl Countries {
    ...
    pub const COLUMNS: &'static str = r#""CountryId","Abberviation","FullName","StatusId""#;
    pub const COLUMNS_UPDATE: &'static str = r#""CountryId"=$1,"Abberviation"=$2,"FullName"=$3,"StatusId"=$4 WHERE "CountryId"=$1"#;

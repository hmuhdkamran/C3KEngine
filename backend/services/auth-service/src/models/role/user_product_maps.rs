...
impl UserProductMaps {
    ...
    pub const COLUMNS_ARRAY: [&'static str; 4] = ["UserProductMapId","ProductId","UserId","StatusId"];
...
let _ = args.add(self.status_id.clone());
    ...
    pub fn new(user_product_map_id: Uuid,product_id: Uuid,user_id: Uuid,status_id: Uuid) -> Self {
        Self {
            user_product_map_id,
product_id,
user_id,

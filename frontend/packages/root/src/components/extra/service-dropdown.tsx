  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center space-x-2 text-white hover:text-gray-300 focus:outline-none transition duration-300"
      >
      ...
      <div ref={dropdownRef}
        className={`absolute left-0 mt-4 w-[75vw] sm:w-[600px] bg-white rounded-lg shadow-lg z-50 p-3 
          grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 transition-all duration-300 transform ${

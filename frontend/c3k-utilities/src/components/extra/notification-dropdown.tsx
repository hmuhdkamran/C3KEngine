...
const NotificationDropdown: FC<DropdownProps> = ({
  showDropdown,
  toggleDropdown,
}) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={`absolute mt-2 w-64 sm:w-80 bg-white shadow-lg rounded-md overflow-hidden z-50 md:left-0 ${
            showDropdown
              ? "sm:left-1/2 scale-100 opacity-100"

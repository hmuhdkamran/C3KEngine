...
const SidebarMenu: FC<SidebarProps> = ({
  ...
  return (
    <>
      ...
      <div
        className={`fixed inset-y-0 left-0 w-64 bg-white text-gray-800 border-r border-gray-200 shadow-lg z-50 rounded-tr-lg rounded-br-lg transform transition-transform duration-300 ease-in-out ${
